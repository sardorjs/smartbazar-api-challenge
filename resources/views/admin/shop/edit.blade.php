<x-app-layout>
        ...
        <form action="{{ route('admin.shop.update', $shop) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="flex flex-row flex-wrap justify-start gap-4 items-end mb-4">
                    ...
                    @if ($rayons->isNotEmpty())
                        ...
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pr-6 pl-2.5 py-2.5">
                            ...
                            @foreach ($rayons as $rayon)
                                <option value="{{ $rayon->id }}" {{ $shop->rayon_id == $rayon->id ? 'selected' : '' }}>{{ $rayon->name }}</option>
                            @endforeach
                        </select>
                    @else
                        <p class="p-4 text-base border-solid bg-slate-200">
                    ...
                    @if ($merchants->isNotEmpty())
                        ...
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pr-6 pl-2.5 py-2.5">
                            ...
                            @foreach ($merchants as $merchant)
                                <option value="{{ $merchant->id }}" {{ $shop->merchant_id == $merchant->id ? 'selected' : '' }}>{{ $merchant->name }}</option>
                            @endforeach
                        </select>
                    @else
                        <p class="p-4 text-base border-solid bg-slate-200">
                ...
                <div>
                    ...
                    <label class="inline-flex items-center cursor-pointer">
                        <input name="status" type="checkbox" class="sr-only peer" {{ $shop->status ? 'checked' : '' }}>
            ...
            <div class="flex flex-row flex-wrap justify-start gap-4 items-end mb-4">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name"  placeholder="e.g: Livestock Super Market" required value="{{ $shop->name }}"
                ...
                <div>
                    ...
                    <input type="text" id="latitude" name="latitude"  placeholder="e.g: 41.309852" required value="{{ $shop->latitude }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="longitude" name="longitude"  placeholder="e.g: 69.277093" required value="{{ $shop->longitude }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="address" name="address"  placeholder="e.g: Turkiston Street, 12А" value="{{ $shop->address }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="phone" name="phone"  placeholder="e.g: +998909991144" value="{{ $shop->phone }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                </div>
            ...
            <div class="flex flex-row flex-wrap justify-start gap-4 items-end mb-4">
                ...
                <div>
                    ...
                    <textarea type="text" id="schedule" name="schedule"  placeholder="e.g: Monday: 09:00AM - 10:00PM ..."
                        rows="8" cols="64"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">{{ old('schedule') ?? $shop->schedule }}
                    </textarea>
                </div>
            </div>
    ...
    {{-- END Script - change Rayons from selecting a city --}}
</x-app-layout>
